...
import { red700 } from 'react-native-paper/lib/typescript/styles/colors';
  ...
  render(){
    return(
      ...
      <View style={styles.buttons}>
        ...
        <DecrementButton  text='Decrement - 'onPress={this.Decrement}></DecrementButton>
      ...
      <View style={styles.alerts}>
        ...
        <Text style={{fontSize:35}}>Set Limit</Text>
